...
parser.add_argument('--directory', help='the directory where the PART files stays',
                    default='/user/smuledata/reco/PROD/training_metrics_roc/algorithm=ACTION/itemtype=PERF/appfamily=SING/model=perf_model_feedback_loop_20180529/day=2018-08-08/')
