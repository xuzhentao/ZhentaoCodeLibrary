...
from Class_PrintStatus import Class_PrintStatus
...
if __name__ == "__main__":
	...
	progressbar = Class_ProgressBar(	int_total = 12345000, 		#	[must]		This is the estimation of the total amount of count.
										float_progressDelta = 0.01, #	(optional)	This is the delta of reporting, e.g. 0.1 will report 1/0.1 = 10 times.
