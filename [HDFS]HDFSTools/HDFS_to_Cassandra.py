...
parser.add_argument('--directory', help = 'the directory where the PART files stays', default = "/user/smuledata/reco/PROD/models/algorithm=ACTION/itemtype=PERF/appfamily=SING/model=perf_model_20150828_explorebyactionastrainingdata_negCF_V2/day=2019-05-02")
